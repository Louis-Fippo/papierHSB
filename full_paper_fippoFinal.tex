...
\input{partsFinal1/intro}
\input{partsFinal1/methods}
\input{partsFinal1/results}
\input{partsFinal1/conclusion}
\input{partsFinal1/acknowledgements}

\bibliographystyle{plain}
\bibliography{biblio.bib}

\input{partsFinal1/annexes}
