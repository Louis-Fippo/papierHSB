...
\begin{figure}[!p]
 \centering
 \includegraphics[width=15cm, height=10cm]{images/net_cg_v3.png}
...
From this procedure $200$ gene transcripts were selected. 
 ...
 \scalebox{0.45}{
  \begin{tikzpicture}[shorten >=1pt,->,draw=black!50, node distance=\layersep]
   ...
   %add some feedbacks 
    ...
    \path (I-5) edge[inh, red, bend right] (H-5);
    \path (I-1) edge[inh, red, bend left] (H3-1);
    \path (I-3) edge[inh, red] (H3-2);
