...
\modCG{ studies \cite{AMSW2012,RAT2006} have proposed more elaborate methods for parameters estimation from gene expression data. These methods are well adapted in the case of biochemical reactions where 
...
%}
 ...
 number of accepted traces ($Trace_{accp}$). Therefore the percentage of accep traces is $\frac{Trace_{accp}}{Trace_{N}}$ if we assume that $Trace_{N}$ is the total 
