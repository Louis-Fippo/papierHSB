...
$3$ traces with a good acceptance rate ($> 94\%$) when considering 1 level of tolerance, which are: MKP1, MKP3, SM22, and TfR;
and finally $3$ traces, for which the model failed to predict their expressions:  ET1, Hes5, and TNFa.
We think therefore that our model predicts relatively well $9$ out of $12$ experimental traces.
Errors on the prediction of the missing $3$ components may missing regulatory interactions.
