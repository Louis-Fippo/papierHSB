...
\caption{Percentage of acceptance traces. First column represente the Automata that is used to check if a given trace is acceptance for a component in the second 
column. In the third column we have the percentage of acceptance traces.}
\label{traceAnalysis}
\centering
%table of result
\begin{tabular}{|c|c||c|}
