...
for modeling dynamic of BRN. All of these models are purely qualitative and discrete, thus do not incorporate  quatitative time or other quantities. 
...
It relies on timed automata implemented. Anyways, this models do not take into acount the stochastic aspects of the influences  of BRN.
}
