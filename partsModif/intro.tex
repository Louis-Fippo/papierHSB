...
%This to come later =========================
\modCG{
The advantages and complementariness of our method with respect to the aforecited approaches are that 
...
that describes deterministic (population average) behaviour in a continuous maner. Even for simple model including a simple interaction between two components, 
...
for modeling dynamic of a BRN. All of these models are purely qualitative and discrete, thus do not incorporate  quantitative time or other quantities. 
Discrete models have been extended to integrate quantitative aspects, such as the time aspect, which was introduced by \cite{Siebert06,batt2007timed,Ahmad08,van2013timed}. 
These methods rely on timed automata implementations and do not take into acount the stochastic aspects of the influences of a BRN.
}
