...
\modCG{ Unraveling and describing the mechanisms} involved in the regulation of a cell-based biological system is a fundamental 
...
the prediction power of this model concerning the simultaneously predicted traces of $12$ \modCG{mRNA expression} components of the system upon system stimulation.
