...
\caption{\bf Plot of $12$ selected genes. $X$ axis represents time duration of the experiment measured in hours. $Y$ axis represents the $log_{2}$ expression level of genes with respect to control.}
\label{fig:tsd}
\end{figure}
