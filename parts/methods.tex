...
\caption{\bf Illustration of the estimation of temporal parameters from time series data: $r_{i}=\frac{1}{t_{i}-t_{i-1}}$. $MaxLevel$ represents the maximum expression. $MinLevel$ represents the minimum 
