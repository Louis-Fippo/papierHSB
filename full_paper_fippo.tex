...
\title{Integrating time-series data in large-scale discrete \modCG{cell-based} models}
...
concurrent events.
\keywords{time-series data, large-scale models, compositional approach, stochastic pi-calculus}
\end{abstract}
