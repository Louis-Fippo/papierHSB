...
\title{Integrating time-series data on large-scale discrete models}
...
\and Olivier Roux\and Carito Guziolowski}
%
...
automatic way of detecting and translating biological motifs from a the 
...
concurrent events.
\keywords{Model construction, data integration, parameters estimation, large-scale network.}
\end{abstract}
